...
const CarpmaPage = () => {
  ...
  const generateNumbers = () => {
    let max = difficulty === "easy" ? 5 : difficulty === "medium" ? 10 : 12;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-yellow-50 p-4 sm:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <ProgressTracker topic="Çarpma" correctAnswers={sessionCorrectAnswers} totalQuestions={sessionTotalQuestions} />
        
        <div className="mt-8 text-center">
          <h2 className="text-xl sm:text-2xl font-bold text-orange-600">Oturum Puanı: {sessionPoints}</h2>
          {sessionPoints >= 50 && (
